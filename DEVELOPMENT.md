...
│   ├── data/            # 데이터 파일 (총 2,300 단어)
│   │   ├── vocabBasicData.js      # 기초 500 단어 (25 카테고리)
│   │   ├── vocabDailyData.js      # 일상 500 단어 (25 카테고리)
│   │   ├── vocabBusinessData.js   # 비즈니스 500 단어 (25 카테고리)
│   │   ├── vocabTopikData.js      # TOPIK 800 단어 (40 카테고리)
...
**어휘 확장 (800→2,300 단어):**
- 기초 필수: 200→500 (10→25 카테고리) — 동물, 의류, 인사, 학교, 교통, 가정용품, 요일, 위치, 부사, 재질, 스포츠, 도구, 감정, 수량, 생활표현
- 일상 필수: 200→500 (10→25 카테고리) — 전화/인터넷, 은행, 병원, 공공장소, 가족행사, 외식, 미용, 이사, 반려동물, SNS, 주말, 운전, 우편, 비상, 일상표현
- 비즈니스: 200→500 (10→25 카테고리) — 협상, 고객서비스, 보고서, 프로젝트, 물류, 투자, 보험, 수출입, 제조, 품질, 교육, 네트워킹, 기업문화, 스타트업, 비즈니스매너
- TOPIK: 200→800 (10→40 카테고리) — 미디어, 역사, 지리, 철학, 문학, 스포츠, 법, 도시, 농업, 에너지, 인구, 국제관계, 주거, 패션, 음악, 컴퓨팅, 언어학, 사회학, 천문, 통계, 윤리, 경제심화, 환경심화, 정치심화, 문화연구, 고급동사1/2, 고급형용사, 연결표현, 관용표현

**전통 민요 (저작권 없는 노래 6곡):**
- K-Pop 페이지에 전통 민요 섹션 추가
- 아리랑, 도라지 타령, 밀양 아리랑, 강강술래, 옹헤야, 닐리리야
- 각 곡별: 한국어 가사, 로마자 표기, 영문 번역, 핵심 어휘 제공

**단어 수 업데이트:**
- NAV_MENU: 기초 500, 일상 500, 비즈니스 500, TOPIK 800
- CURRICULUM_CARDS: 2,300 단어
- Home 히어로 통계: 2,300+

**변경 파일 수: 7개**
- 데이터: vocabBasicData.js, vocabDailyData.js, vocabBusinessData.js, vocabTopikData.js
- 페이지: KPop.jsx, Home.jsx
- 설정: site.js
