...
export default function Restaurant() {
  ...
  return (
    <>
      <SEOHead title={String(t('음식점 한국어 - Korean Pro', 'Restaurant Korean - Korean Pro'))} description={String(t('한국 식당에서 주문, 추천, 계산 표현을 배우세요.', 'Learn Korean expressions for ordering and paying at restaurants.'))} />
