...
export default function Greetings() {
  ...
  return (
    <>
      <SEOHead title={String(t('인사 & 소개 - Korean Pro', 'Greetings & Introductions - Korean Pro'))} description={String(t('한국어 인사와 자기소개 표현을 배워보세요.', 'Learn Korean greetings and self-introduction expressions.'))} />
