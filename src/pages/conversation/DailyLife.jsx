...
export default function DailyLife() {
  ...
  return (
    <>
      <SEOHead title={t('일상생활 표현 - Korean Pro', 'Daily Life Expressions - Korean Pro')} description={t('아침 루틴, 날씨, 약속 잡기 등 일상 한국어 표현을 배우세요.', 'Learn everyday Korean expressions for routines, weather, and plans.')} />
