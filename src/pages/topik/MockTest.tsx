...
export default function MockTest() {
  ...
  if (!testStarted) {
    return (
      <>
        <SEOHead
          title={String(t('TOPIK 모의 시험 - Korean Pro', 'TOPIK Mock Test - Korean Pro'))}
  ...
  if (testFinished) {
    ...
    return (
      <>
        <SEOHead title={String(t('시험 결과 - Korean Pro', 'Test Results - Korean Pro'))} />
  ...
  return (
    <>
      <SEOHead title={String(t('TOPIK 모의 시험 진행 중', 'TOPIK Mock Test In Progress'))} />
