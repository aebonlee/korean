...
const sections = [
  { id: 'paragraph-structure', ko: '문단의 구조', en: 'Paragraph Structure' },
  { id: 'connectors', ko: '유용한 접속사', en: 'Useful Connectors' },
  { id: 'sample-paragraph', ko: '예시 문단', en: 'Sample Paragraph' },
  { id: 'writing-prompts', ko: '쓰기 연습 주제', en: 'Writing Practice Topics' },
];
...
export default function Paragraph() {
  ...
  return (
    <>
      <SEOHead
        title={String(t('문단 쓰기 - Korean Pro', 'Paragraph Writing - Korean Pro'))}
      ...
      <PageLayout sections={sections} category="writing">
        {/* Paragraph Structure */}
        <section id="paragraph-structure" className="lesson-section" data-aos="fade-up">
          <div className="container">
        ...
        {/* Connectors */}
        <section id="connectors" className="lesson-section" data-aos="fade-up">
          <div className="container">
        ...
        {/* Sample Paragraph */}
        <section id="sample-paragraph" className="lesson-section" data-aos="fade-up">
          <div className="container">
        ...
        {/* Writing Prompts */}
        <section id="writing-prompts" className="lesson-section" data-aos="fade-up">
          <div className="container">
