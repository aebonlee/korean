...
const sections = [
  { id: 'sov-order', ko: 'SOV 어순', en: 'SOV Word Order' },
  { id: 'negative', ko: '부정문', en: 'Negative Sentences' },
  { id: 'questions', ko: '의문문', en: 'Question Sentences' },
];
...
export default function BasicSentence() {
  ...
  return (
    <>
      <SEOHead title={String(t('기초 문장 - Korean Pro', 'Basic Sentence - Korean Pro'))} description={String(t('한국어 기본 문장 구조를 학습하세요.', 'Learn basic Korean sentence structures.'))} />
      ...
      <PageLayout sections={sections} category="writing">
        <section id="sov-order" className="lesson-section" data-aos="fade-up">
          <div className="container">
        ...
        <section id="negative" className="lesson-section" data-aos="fade-up">
          <div className="container">
        ...
        <section id="questions" className="lesson-section" data-aos="fade-up">
          <div className="container">
            ...
            <div className="tip-box" data-aos="fade-up">
              <h4>{t(<><i className="fas fa-lightbulb"></i> 팁</>, <><i className="fas fa-lightbulb"></i> Tip</>)}</h4>
