...
const topicCards = [
  { id: 'basic', titleKo: '기초 문장', titleEn: 'Basic Sentence', descKo: '한국어 기본 문장 구조와 어순을 익히세요 (SOV)', descEn: 'Learn basic Korean sentence structure and word order (SOV)', icon: 'fa-solid fa-pen', link: '/writing/basic', color: '#4A8FE7' },
  { id: 'paragraph', titleKo: '문단 작성', titleEn: 'Paragraph Writing', descKo: '주제문, 뒷받침 문장으로 문단을 구성하세요', descEn: 'Compose paragraphs with topic and supporting sentences', icon: 'fa-solid fa-file-lines', link: '/writing/paragraph', color: '#22C55E' },
  { id: 'essay', titleKo: '에세이', titleEn: 'Essay Writing', descKo: '서론, 본론, 결론 구조로 한국어 에세이를 쓰세요', descEn: 'Write Korean essays with introduction, body, and conclusion', icon: 'fa-solid fa-scroll', link: '/writing/essay', color: '#A855F7' },
];
...
export default function WritingHome() {
  ...
  return (
    <>
      <SEOHead title={t('한국어 작문 - Korean Pro', 'Korean Writing - Korean Pro')} description={t('기초 문장부터 에세이까지 체계적인 한국어 작문 학습', 'Systematic Korean writing from basic sentences to essays')} />
