...
export default function SpeechPage() {
  ...
  const handleSelect = useCallback((catIdx: number, sentence: any) => {
  ...
  return (
    <>
      <SEOHead
        title={String(t('발음 연습 - Korean Pro', 'Speech Practice - Korean Pro'))}
        description={String(t('한국어 발음을 연습하고 실시간 피드백을 받으세요.', 'Practice Korean pronunciation and get real-time feedback.'))}
      />
              ...
              <section id="practice" className="lesson-section">
                <div className="container">
                  <SpeechPractice
                    ...
                    targetMeaning={String(t(selectedSentence.meaning, selectedSentence.meaningEn))}
                  />
                </div>
              </section>
