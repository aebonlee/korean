...
function Dashboard() {
  ...
  return (
    <>
      <SEOHead
        title={t('대시보드 - Korean Pro', 'Dashboard - Korean Pro')}
        description={t('Korean Pro 학습 대시보드. 학습 진도와 활동을 확인하세요.', 'Korean Pro learning dashboard. Check your progress and activity.')}
      />
