...
export default function Vowels() {
  ...
  const sections = [
    { id: 'basic-vowels', ko: '기본 모음', en: 'Basic Vowels' },
    { id: 'compound-vowels', ko: '복합 모음', en: 'Compound Vowels' },
  ];

  return (
    <>
      <SEOHead
        title={String(t('한국어 모음 - Korean Pro', 'Korean Vowels - Korean Pro'))}
      ...
      <PageLayout sections={sections} category="hangul">
        {/* Basic Vowels */}
        <section className="lesson-section" id="basic-vowels" data-aos="fade-up">
          <div className="container">
            ...
            <div className="tip-box" data-aos="fade-up">
              <h4>{t(<><i className="fas fa-lightbulb"></i> 모음 분류</>, <><i className="fas fa-lightbulb"></i> Vowel Classification</>)}</h4>
              <ul>
        ...
        {/* Compound Vowels */}
        <section className="lesson-section" id="compound-vowels" data-aos="fade-up">
          <div className="container">
            ...
            <div className="tip-box" data-aos="fade-up">
              <h4>{t(<><i className="fas fa-lightbulb"></i> ㅐ vs ㅔ 차이점</>, <><i className="fas fa-lightbulb"></i> Difference between ㅐ and ㅔ</>)}</h4>
              <p>
                {t(
