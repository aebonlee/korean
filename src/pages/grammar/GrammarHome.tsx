...
export default function GrammarHome() {
  ...
  return (
    <>
      <SEOHead title={String(t('한국어 문법 - Korean Pro', 'Korean Grammar - Korean Pro'))} description={String(t('조사, 동사 활용, 존댓말, 문장 패턴 등 한국어 핵심 문법을 배우세요.', 'Learn Korean grammar: particles, verb conjugation, honorifics, and sentence patterns.'))} />
