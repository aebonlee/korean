...
export default function Honorifics() {
  ...
  const sections = [
    { id: 'formal-informal', ko: '1. 격식체 vs 비격식체', en: '1. Formal vs Informal' },
    { id: 'honorific-expressions', ko: '2. 존경 표현', en: '2. Honorific Expressions' },
  ];

  return (
    <>
      <SEOHead title={String(t('존댓말 - Korean Pro', 'Honorifics - Korean Pro'))} description={String(t('한국어 존대법 체계를 배우세요.', 'Learn the Korean honorific system.'))} />
      ...
      <PageLayout sections={sections} category="grammar">
        <section id="formal-informal" className="lesson-section" data-aos="fade-up">
          <div className="container">
        ...
        <section id="honorific-expressions" className="lesson-section" data-aos="fade-up">
          <div className="container">
            ...
            <div className="tip-box" data-aos="fade-up">
              <h4>{t(<><i className="fas fa-lightbulb"></i> 존댓말 사용 팁</>, <><i className="fas fa-lightbulb"></i> Honorific Tips</>)}</h4>
