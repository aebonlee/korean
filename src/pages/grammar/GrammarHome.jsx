...
const TOPIC_CARDS = [
  { id: 'particles', titleKo: '조사 (Particles)', titleEn: 'Particles', descKo: '은/는, 이/가, 을/를 등 한국어 핵심 조사를 배웁니다.', descEn: 'Learn essential Korean particles: 은/는, 이/가, 을/를, and more.', icon: 'fa-solid fa-link', link: '/grammar/particles', color: '#4A8FE7' },
  { id: 'verb', titleKo: '동사 활용 (Verb Conjugation)', titleEn: 'Verb Conjugation', descKo: '현재, 과거, 미래 시제와 다양한 동사 활용법을 배웁니다.', descEn: 'Learn present, past, future tenses and various verb conjugation patterns.', icon: 'fa-solid fa-rotate', link: '/grammar/verb-conjugation', color: '#22C55E' },
  { id: 'honorifics', titleKo: '존댓말 (Honorifics)', titleEn: 'Honorifics', descKo: '한국어의 존대법 체계와 격식체/비격식체를 배웁니다.', descEn: 'Learn the Korean honorific system, formal and informal speech levels.', icon: 'fa-solid fa-crown', link: '/grammar/honorifics', color: '#F59E0B' },
  { id: 'patterns', titleKo: '문장 패턴 (Sentence Patterns)', titleEn: 'Sentence Patterns', descKo: '~고 싶다, ~(으)ㄹ 수 있다 등 핵심 문장 패턴을 배웁니다.', descEn: 'Learn key sentence patterns like ~고 싶다, ~(으)ㄹ 수 있다, and more.', icon: 'fa-solid fa-diagram-project', link: '/grammar/sentence-patterns', color: '#A855F7' },
];
        ...
        <section className="content-section" data-aos="fade-up">
          ...
          <div className="card-grid card-grid--2">
            {TOPIC_CARDS.map((card, index) => (
              <Link to={card.link} key={card.id} className="topic-card" data-aos="fade-up" data-aos-delay={index * 100}>
