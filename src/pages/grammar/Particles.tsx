...
export default function Particles() {
  ...
  return (
    <>
      <SEOHead title={String(t('조사 - Korean Pro', 'Particles - Korean Pro'))} description={String(t('한국어 핵심 조사를 배우세요: 은/는, 이/가, 을/를 등.', 'Learn essential Korean particles: 은/는, 이/가, 을/를, and more.'))} />
