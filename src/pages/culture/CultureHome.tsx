...
export default function CultureHome() {
  ...
  return (
    <>
      <SEOHead
        title={String(t('한국 문화 - Korean Pro', 'Korean Culture - Korean Pro'))}
        description={String(t('K-Drama와 K-Pop을 통해 한국어를 재미있게 배우세요.', 'Learn Korean in a fun way through K-Drama and K-Pop.'))}
      />
