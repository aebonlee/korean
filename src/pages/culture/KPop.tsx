...
export default function KPop() {
  ...
  return (
    <>
      ...
      <SEOHead
        title={String(t('K-Pop 한국어 - Korean Pro', 'Learn Korean through K-Pop - Korean Pro'))}
        description={String(t('K-Pop 가사에 나오는 한국어 단어와 팬 용어를 배우세요.', 'Learn Korean words from K-Pop lyrics and fan terminology.'))}
      />
