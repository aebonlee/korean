...
export default function KDrama() {
  ...
  return (
    <>
      <SEOHead
        title={String(t('K-Drama 한국어 - Korean Pro', 'Learn Korean through K-Drama - Korean Pro'))}
        description={String(t('K-Drama에서 자주 나오는 한국어 표현과 문화 어휘를 배우세요.', 'Learn Korean expressions and cultural vocabulary commonly heard in K-Dramas.'))}
      />
