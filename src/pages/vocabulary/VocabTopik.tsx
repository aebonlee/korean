...
export default function VocabTopik() {
  ...
  return (
    <>
      <SEOHead title={String(t('TOPIK 어휘 - Korean Pro', 'TOPIK Vocabulary - Korean Pro'))} description={String(t(`TOPIK 시험 필수 어휘 ${TOPIK_WORDS.length}개를 학습하세요.`, `Study ${TOPIK_WORDS.length} essential TOPIK vocabulary words.`))} />
