...
export default function VocabBasic() {
  ...
  return (
    <>
      <SEOHead title={t('기초 필수 단어 - Korean Pro', 'Basic Essential Words - Korean Pro')} description={t(`한국어 기초 필수 단어 ${BASIC_WORDS.length}개를 학습하세요.`, `Study ${BASIC_WORDS.length} essential basic Korean words.`)} />
