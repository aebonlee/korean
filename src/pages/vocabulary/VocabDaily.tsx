...
export default function VocabDaily() {
  ...
  return (
    <>
      <SEOHead title={String(t('일상 필수 단어 - Korean Pro', 'Daily Essential Words - Korean Pro'))} description={String(t(`일상생활 필수 한국어 단어 ${DAILY_WORDS.length}개를 학습하세요.`, `Study ${DAILY_WORDS.length} essential daily Korean words.`))} />
