...
export default function VocabBusiness() {
  ...
  return (
    <>
      <SEOHead title={String(t('비즈니스 어휘 - Korean Pro', 'Business Vocabulary - Korean Pro'))} description={String(t(`비즈니스 한국어 어휘 ${BUSINESS_WORDS.length}개를 학습하세요.`, `Study ${BUSINESS_WORDS.length} business Korean vocabulary words.`))} />
